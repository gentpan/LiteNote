                ...
                <div class="music-player-suite">
                    <article class="music-disc-player" data-music-disc-player data-current-index="0" data-current-id="{{ $featured->id }}">
                        ...
                        <div class="music-vinyl-side">
                            <img class="music-tonearm-img" src="/themes/ember/assets/images/music/tonearm.png" alt="" loading="lazy" width="305" height="555">
                            <div class="music-record-shell">
                                <img class="music-record-border" src="/themes/ember/assets/images/music/record-border.png" alt="" loading="lazy" width="828" height="828">
