...
@if(!empty($currentAdmin))
    ...
    <form class="front-publish-form" method="post" action="/talk/publish">
        ...
        <input type="hidden" name="post_type" value="talk" data-post-type-input>
        ...
        <textarea name="content" rows="4" placeholder="今天想说点什么...（用 #关键词 添加标签，会自动渲染；X 卡片可留空）"></textarea>
        <div class="front-publish-images">
            ...
            <button type="button"
                    class="fp-x-btn fp-tool-btn"
                    aria-expanded="false"
                    aria-controls="front-publish-x-panel">
        ...
        <div class="front-publish-x" id="front-publish-x-panel" hidden>
            <input type="text" name="tweet_url" placeholder="粘贴 X 链接，例如 https://x.com/user/status/1994155465488670828">
        </div>
