...
@section('content')
    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            @php
                $flagUrl = \App\Services\IpGeoService::flagUrl((string)($c['geo_country_code'] ?? ''));
                $location = \App\Services\IpGeoService::locationLabel($c);
                $flagTitle = trim((string)($c['ip'] ?? ''));
                if ($flagTitle !== '' && $location !== '') {
                    $flagTitle .= ' · ' . $location;
                } elseif ($flagTitle === '') {
                    $flagTitle = $location;
                }
            ...
            <tr>
                ...
                <td>{!! \App\Core\Helper::dateTimeTag($c['created_at']) !!}</td>
                <td>
