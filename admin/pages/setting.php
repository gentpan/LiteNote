            ...
            <div class="settings-section">
                @foreach($items as $item)
                    ...
                    <div class="form-group @if($isToggle) form-group-toggle @endif">
                        ...
                        @if($item['k'] === 'site_theme')
                            <select name="settings[site_theme]" id="setting-site_theme">
                            ...
                            @if(!empty($themes[$activeTheme]['description']))
                                <p class="form-help">{{ $themes[$activeTheme]['description'] }}</p>
                            @endif
                        @elseif($isToggle)
                            {{-- 圆形 iOS 风格 toggle --}}
